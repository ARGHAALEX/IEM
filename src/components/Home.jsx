...
const StateDashboard = () => {
    ...
    const states = [
      { id: 1, name: "Andhra Pradesh", icon: wbimg, code: "AP" },
      { id: 2, name: "Arunachal Pradesh", icon: wbimg, code: "AR" },
      { id: 3, name: "Assam", icon: wbimg, code: "AS" },
      { id: 4, name: "Bihar", icon: bh, code: "BR" },
      { id: 5, name: "Chhattisgarh", icon: wbimg, code: "CG" },
      { id: 6, name: "Goa", icon: wbimg, code: "GA" },
